...
const ASSET_QUERIES: Record<string, string> = {
  ...
  "6e1": "Euro EUR/USD forex ECB",
  "6b1": "British Pound GBP/USD forex Bank of England",
  "6j1": "Japanese Yen USD/JPY forex Bank of Japan",
  "6s1_fx": "Swiss Franc USD/CHF forex SNB",
  "6a1": "Australian Dollar AUD/USD forex RBA",
  "6c1": "Canadian Dollar USD/CAD forex Bank of Canada",
