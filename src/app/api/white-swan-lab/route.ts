...
export async function GET(request: Request) {
  ...
  const subDir = phase === 'final' ? 'portfolio-lab-final' : phase === 'pb' ? 'portfolio-lab-pb' : phase === 'v4' ? 'portfolio-lab-v4' : phase === 'v3' ? 'portfolio-lab-v3' : phase === 'v2' ? 'portfolio-lab-v2' : 'portfolio-lab';
  ...
  try {
    ...
    if (type === 'comparison') {
      const CAPS = phase === 'final' ? [10000, 12500, 15000, 20000, 25000, 50000] : [10000, 12500, 15000, 20000];
