...
const GLOBE_ASSETS: AssetItem[] = [
  ...
  { id: "ym1", name: "Dow Jones Futures (YM1!)", category: "White Swan Portfolio", iconKey: "us", tvSource: "CME_MINI:YM1!", symbol: "YM=F", lat: 41.9, lng: -87.6, country: "USA", color: "#6366f1", defaultEnabled: true, showOnGlobe: true, locations: [{ lat: 41.9, lng: -87.6, label: "Chicago", weight: 1 }] },
  { id: "nq1", name: "Nasdaq Futures (NQ1!)", category: "White Swan Portfolio", iconKey: "us", tvSource: "CME_MINI:NQ1!", symbol: "NQ=F", lat: 40.7, lng: -74.0, country: "USA", color: "#3b82f6", defaultEnabled: true, showOnGlobe: true, locations: [{ lat: 40.7, lng: -74.0, label: "New York", weight: 1 }] },
  ...
  // ── Intraday MT ──
  { id: "eurusd_30m", name: "EUR/USD (30M)", category: "Intraday MT", iconKey: "eu", tvSource: "FX:EURUSD", symbol: "EURUSD=X", lat: 50.1, lng: 8.7, country: "Eurozone", color: "#3b82f6", defaultEnabled: true, showOnGlobe: true, locations: [{ lat: 50.1, lng: 8.7, label: "Frankfurt", weight: 1 }] },
  ...
  { id: "gbpusd_30m", name: "GBP/USD (30M)", category: "Intraday MT", iconKey: "gb", tvSource: "FX:GBPUSD", symbol: "GBPUSD=X", lat: 51.5, lng: -0.1, country: "UK", color: "#8b5cf6", defaultEnabled: true, showOnGlobe: true, locations: [{ lat: 51.5, lng: -0.1, label: "London", weight: 1 }] },
  ...
  // ── Core Invest ──
  { id: "qqq", name: "QQQ (Nasdaq ETF)", category: "Core Invest", iconKey: "us", tvSource: "NASDAQ:QQQ", symbol: "QQQ", lat: 40.7, lng: -74.0, country: "USA", color: "#3b82f6", defaultEnabled: true, showOnGlobe: true, locations: [{ lat: 40.7, lng: -74.0, label: "New York", weight: 1 }] },
  ...
  { id: "glgg", name: "GLGG (Clean Water ETF)", category: "Core Invest", iconKey: "eu", tvSource: "LSE:GLGG", symbol: "GLGG.L", lat: 53.3, lng: -6.3, country: "Ireland", color: "#06b6d4", defaultEnabled: true, showOnGlobe: true, locations: [{ lat: 53.3, lng: -6.3, label: "Dublin", weight: 1 }] },
  { id: "fiw", name: "FIW (Water ETF)", category: "Core Invest", iconKey: "us", tvSource: "NYSE:FIW", symbol: "FIW", lat: 40.7, lng: -74.0, country: "USA", color: "#0ea5e9", defaultEnabled: true, showOnGlobe: true, locations: [{ lat: 40.7, lng: -74.0, label: "New York", weight: 1 }] },
  ...
  { id: "ethusd", name: "Ethereum (ETH/USD)", category: "Crypto", iconKey: "eth", tvSource: "BITSTAMP:ETHUSD", symbol: "ETH-USD", lat: 37.4, lng: -122.1, country: "USA", color: "#818cf8", defaultEnabled: true, showOnGlobe: true, locations: [{ lat: 37.4, lng: -122.1, label: "San Francisco", weight: 1 }] },
  ...
  { id: "natgas", name: "Natural Gas", category: "Commodities", iconKey: "gas", tvSource: "NYMEX:NG1!", symbol: "NG=F", lat: 29.7, lng: -95.4, country: "USA", color: "#60a5fa", defaultEnabled: true, showOnGlobe: true, locations: [{ lat: 29.7, lng: -95.4, label: "Henry Hub", weight: 1 }] },
