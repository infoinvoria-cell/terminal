...
const ANOMALY: StrategyRow[] = [
  {
    ...
    engine: "WATCH · Fri 00:00 UTC close -> Fri last-bar close · ATR14 SL1.0 · no filter", pillar: "anomaly", weight: 0,
    sharpeOos: null, cagr: null, maxDd: null, calmar: 0.43, pf: 1.32, trades: 659, wfOos: "10/13",
    status: "watch", dataFile: "anomaly/gc1_friday_long.json", exchange: "COMEX",
    isNotes: "FINAL LOCK AUDIT 2026-08-09 · VERDICT: WATCH (7/9 gates) · weight=0% until roll artifact resolved · Locked: Fri 00:00 UTC close -> last Fri bar close, ATR=14 SL=1.0, no filter · IS plateau: 16/16 combos PF>1 · WFO 5Y/1Y: 10/13 folds positive, agg PF=1.32, exp_R=0.23R, Calmar-R=0.43, MaxDD-R=27.0R · WFO 7Y/1Y sensitivity: 8/11 positive · KHV 2021-2026 (NOT pristine OOS): PF=1.25 2021+1.29 2022-5.96R 2023+22.2R 2024+26.2R 2025-8.2R 2026+4.4R · DST: edge in both US STANDARD (PF=1.41) and US DAYLIGHT (PF=1.38) - PASS · Multiple testing: Bonf-adj p=0.016 survives; block-bootstrap p=0.49 does not (signal exists but not overwhelming) · ROLL ARTIFACT FAIL: roll-window PF=2.40 vs non-roll PF=1.20 (2.0x ratio, gate=1.15x) - 75 roll trades drive outsized PF; must investigate stripping roll trades · Cost GC: avg stop 4.04 pts, dollar risk $404/ct, RT $14, cost=0.035R, PF after 2x stress=1.21 PASS · Cost MGC: cost=0.062R, PF after 2x=1.13 PASS · Portfolio gate: marginal Calmar -5.19 vs GLD+YM baseline (high GC-GLD corr r=0.65 dilutes diversification benefit) · GLD corr r=0.65; 9/12 overlap years both positive · Next step: re-run WFO stripping roll-window trades; if non-roll-only PF>1.15 reconsider portfolio gate · script: run_white_swan_gold_friday_final_audit.py · report: white_swan_gold_friday_final_audit.json",
  },
  {
