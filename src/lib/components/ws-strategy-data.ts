...
const ANOMALY: StrategyRow[] = [
  ...
  },
  {
    ...
    sharpeOos: null, cagr: null, maxDd: null, calmar: 0.13, pf: 1.20, trades: 414, wfOos: "13/19",
    status: "active", dataFile: "anomaly/ym1_tat.json", exchange: "CBOT",
    isNotes: "CONFIRMED KEEP · audit v1 2026-08-09 · IS 2002–2018: 107 trades PF 1.492 Win% 54.2% AvgR 0.093 · IS plateau 100% (120/120 combos PF>1) · WFO 19-fold (OOS 2007–2025): 13/19 positive Agg PF 1.202 Agg R +20.39 AvgR/yr +1.07 Calmar-R 0.126 MaxDD-R 8.53 · KHV 2021–2025 (NOT PRISTINE OOS): 107 trades PF 1.145 AvgR 0.031 · Cost model YM: 1R=$1,548 RT cost 0.0075R adj-exp 0.0418R (PASS all stress levels) · Roll audit: roll PF 1.193 / non-roll PF 1.249 (no catastrophic artifacts) · neg_monday filter genuine (100% IS plateau) · locked: ATR=14 SL=1.0× RR=2.0 filter=neg_monday · weak period 2009–2012 (4 consec OOS losses post-GFC) · 2025 worst fold (-3.10R) · sharpeOos/cagr/maxDd null (R-based WFO; no clean dollar-CAGR from WFO OOS) · script: run_white_swan_dow_tat_audit_v1.py",
  },
  {
