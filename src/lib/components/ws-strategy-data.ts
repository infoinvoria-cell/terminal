...
const ANOMALY: StrategyRow[] = [
  {
    id: "gc1_friday", ticker: "GC1!", label: "Gold Futures — Friday", group: "Anomaly",
    engine: "Fri 00:00 UTC close → Fri close (same day) · no filter · signal-level", pillar: "anomaly", weight: 7,
    sharpeOos: null, cagr: null, maxDd: null, calmar: null, pf: 1.41, trades: 659, wfOos: "12/13",
    status: "active", dataFile: "anomaly/gc1_friday_long.json", exchange: "COMEX",
    isNotes: "v3 temporal audit 2026-08-09 — GRADE A — 6/6 gates PASS · Data: GC1! 60m combined 133622 bars 2003-07-30→2026-06-05 · TEMPORAL FINDING: Thu→Mon edge has massive CME roll artifact (roll PF 3.8-4.1 vs non-roll PF 1.4) — not a clean anomaly · CLEAN CANDIDATE: Fri 00:00 UTC close → Fri close (same-day intraday, no roll artifact) · Signal (2003-2020): n=858 mean_ret=+0.155% WR=59% t=3.98 (Bonf-adj p=0.012 survives 160-cell Bonferroni) · Era stability 4/4 eras positive (era1=0.221% era2=0.165% era3=0.078% era4=0.043% — declining trend noted) · Temporal plateau: 15 combos (±4h entry window × 3 exit types) 100% PF>1 median PF 1.512 · PRE-2021 WFO OOS 13-fold (5yr IS / 1yr OOS): 12/13 positive Agg signal PF 1.413 mean_ret +0.133% n=659 · KHV 2021-2025 (NOT PRISTINE OOS): n=254 PF 1.123 mean_ret +0.045% (edge weaker, still positive) · GLD corr=0.686 (GLD WFO annual 2009-2020 — gold-market factor confirmed) · Cost GC: avg price $1123 RT cost $4.72 → 0.004% of notional; net_exp=+0.129% at 2× stress PASS · Cost MGC: 0.010% → net_exp=+0.123% at 2× stress PASS · Regime (SMA200 exploratory): uptrend PF 1.587 / downtrend PF 1.389 — edge in both; filter exploratory only (meta-selection bias applies) · Roll audit: Fri→Fri intraday not affected by roll window (entries and exits same day) · ⚠ era4 (2021-2025) mean_ret only +0.043% — declining trend across eras; forward tracking required · Note: supersedes v2 DXY-filtered strategy (Grade D, KHV failed) — v3 is a different temporal pattern · locked: entry Fri 00:00 UTC / exit Fri close / no filter / no stop · weight 7% pending forward track · script: run_white_swan_gold_temporal_v3_fast.py · report: white_swan_gold_temporal_map_v3.json",
  },
  {
