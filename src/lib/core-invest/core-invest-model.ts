export const CORE_INVEST_MODEL = {
  ...
  components: [
    ...
    coreComponent("QQQ_PINE_1", "QQQ Pine 1", "QQQ", "strategy", "Long/cash tactical QQQ sleeve", 0.10, "tv_reference_only", null, "Trade-by-Trade-Parität, Rolling Walk Forward und Live-Formel fehlen"),
