...
export const MODEL_REGISTRY: Record<string, ModelCapabilities> = {
  ...
  "groq:groq/compound": { provider: "groq", model: "groq/compound", contextWindow: 8000, maxOutputTokens: 2000, supportsStreaming: false, supportsTools: false, supportsVision: false, latencyClass: "fast", qualityClass: "strong", freeTier: true },
  "groq:openai/gpt-oss-120b": { provider: "groq", model: "openai/gpt-oss-120b", contextWindow: 8000, maxOutputTokens: 2000, supportsStreaming: false, supportsTools: false, supportsVision: false, latencyClass: "fast", qualityClass: "strong", freeTier: true },
  "groq:openai/gpt-oss-20b": { provider: "groq", model: "openai/gpt-oss-20b", contextWindow: 8000, maxOutputTokens: 2000, supportsStreaming: false, supportsTools: false, supportsVision: false, latencyClass: "fast", qualityClass: "basic", freeTier: true },
