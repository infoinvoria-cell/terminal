...
export function getCapabilityRegistry(): Capability[] {
  ...
  return [
    ...
    },
    {
      ...
      requiresRemoteProvider: false,
      allowedExternally: false,
      note: "Qualitative structure only via static context; per-sleeve numeric performance (CAGR/MaxDD/Sharpe) is intentionally NOT hardcoded — Sentinel must source those from live Brain data or say they are unavailable.",
    },
    {
