...
export const INNO_STRATEGY_CARDS: InnoStrategyCard[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { key: "Status", value: "APPROVED_LIVE v2.0 — Engine-Parität bestätigt; Zielgewichte eingefroren; Paper-Trading (kein Live-Broker)", source: "src/lib/core-invest/core-invest-model.ts" },
      { key: "Datenart", value: `${CORE_INVEST_MODEL.validation.historicalSeriesReady} historische Asset-Reihen; alle 3 Strategy-Sleeves engine-validiert; ${CORE_INVEST_MODEL.validation.liveReadyComponents}/8 live-bereit`, source: "src/lib/core-invest/core-invest-model.ts" },
      ...
      { key: "Haltedauer", value: "ETF-Core langfristig; Strategy-Sleeves halten Positionen bis Signal-Exit, SL oder TP", source: "src/lib/core-invest/core-invest-model.ts" },
      { key: "Anzahl Assets", value: "7 Komponenten: QQQ (passiv + Pine 1), GLD, SPMO, SPY, Copper/HG und CHF/6S — QQQ Pine 2 entfernt", source: "src/lib/core-invest/core-invest-model.ts" },
      { key: "Parallele Positionen", value: "Zielmodell bis zu 7 Komponenten gleichzeitig; aktuelle echte Positionen nicht angebunden", source: "src/lib/core-invest/core-invest-model.ts" },
      { key: "Track-Record-Status", value: "OOS 2019–2026: Sharpe 1.153, CAGR +17.69%, MaxDD −22.49%, Calmar 0.786 (RF=0%, tägliche Schlusskurse)", source: "tools/core-invest/calc_ci_oos_v2.py" },
      { key: "Geplante Gewichtung", value: "QQQ 45%, GLD 25%, SPMO 5%, SPY 5%, Pine1 10%, Copper/HG 5%, CHF/6S 5%", source: "src/lib/components/ws-strategy-data.ts" },
