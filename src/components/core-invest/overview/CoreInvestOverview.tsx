      ...
      <div className="mx-auto max-w-[1500px] px-8 py-8">
        ...
        <div className="flex items-center justify-between border-b border-[#141414] pb-4 mb-6">
          <div className="flex items-center gap-4">
            {/* back arrow only — no visible text per design spec */}
            <Link
              href="/komponenten?product=ci"
              aria-label="Zurück zu Komponenten"
              title="Zurück zu Komponenten"
              className="flex items-center justify-center text-[#555] hover:text-[#c0c0c0] transition"
              style={{ width: 22, height: 22, border: '1px solid rgba(255,255,255,0.08)', borderRadius: 5, background: 'rgba(255,255,255,0.03)' }}
            >
              <ArrowLeft size={12} />
            </Link>
        ...
        <div className="grid lg:grid-cols-5 gap-2 mb-8">
          ...
          <div className="lg:col-span-2 space-y-2">
            ...
            <div className="border border-[#141414] p-4">
              ...
              <div className="mt-1 text-[9.5px] text-[#444]">Grey = ETF exposure ($). Gold = model futures margin ($).</div>
            </div>
          </div>
        </div>
