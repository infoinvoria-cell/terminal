              ...
              <div key="layers" style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>
                <button
                  ...
                  style={{
                    ...
                    background: layersOpen ? "rgba(226,202,122,0.16)" : "rgba(226,202,122,0.08)",
                    border: `1px solid ${layersOpen ? "rgba(226,202,122,0.5)" : "rgba(226,202,122,0.3)"}`,
                    cursor: "pointer",
                    display: "flex", alignItems: "center", justifyContent: "center",
                    color: layersOpen ? GOLD : "rgba(255,255,255,0.6)",
