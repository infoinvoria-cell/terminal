...
ASSETS = [
    # ── Agrar ────────────────────────────────────────────────────────────────
    ("ZC1!",   "ZC1!",    "CBOT",       DAILY,               "CBOT_ZC1_D.json",       5000),
    ("ZW1!",   "ZW1!",    "CBOT",       DAILY,               "CBOT_ZW1_D.json",       5000),
    ("ZS1!",   "ZS1!",    "CBOT",       DAILY,               "CBOT_ZS1_D.json",       5000),
    ("CC1!",   "CC1!",    "ICEUS",      DAILY,               "ICEUS_CC1_D.json",      5000),
    ("KC1!",   "KC1!",    "ICEUS",      DAILY,               "ICEUS_KC1_D.json",      5000),
    ("OJ1!",   "OJ1!",    "ICEUS",      DAILY,               "ICEUS_OJ1_D.json",      5000),
    ("SB1!",   "SB1!",    "ICEUS",      DAILY,               "ICEUS_SB1_D.json",      5000),
    ("CT1!",   "CT1!",    "ICEUS",      DAILY,               "ICEUS_CT1_D.json",      5000),
    # ── Metalle ──────────────────────────────────────────────────────────────
    ("GC1!",   "GC1!",    "COMEX",      DAILY,               "COMEX_GC1_D.json",      5000),
    ("SI1!",   "SI1!",    "COMEX",      DAILY,               "COMEX_SI1_D.json",      5000),
    ("HG1!",   "HG1!",    "COMEX",      DAILY,               "COMEX_HG1_D.json",      5000),
    ("PL1!",   "PL1!",    "NYMEX",      DAILY,               "NYMEX_PL1_D.json",      5000),
    ("PA1!",   "PA1!",    "NYMEX",      DAILY,               "NYMEX_PA1_D.json",      5000),
    # ── Energie ──────────────────────────────────────────────────────────────
    ("CL1!",   "CL1!",    "NYMEX",      DAILY,               "NYMEX_CL1_D.json",      5000),
    ("NG1!",   "NG1!",    "NYMEX",      DAILY,               "NYMEX_NG1_D.json",      5000),
    ("RB1!",   "RB1!",    "NYMEX",      DAILY,               "NYMEX_RB1_D.json",      5000),
    # ── Indizes ──────────────────────────────────────────────────────────────
    ("ES1!",   "ES1!",    "CME_MINI",   DAILY,               "CME_MINI_ES1_D.json",   5000),
    ("NQ1!",   "NQ1!",    "CME_MINI",   DAILY,               "CME_MINI_NQ1_D.json",   5000),
    ("YM1!",   "YM1!",    "CBOT_MINI",  DAILY,               "CBOT_MINI_YM1_D.json",  5000),
    ("FDAX1!", "FDAX1!",  "EUREX",      DAILY,               "EUREX_FDAX1_D.json",    5000),
    ("UKX!",   "UKX",     "TVC",        DAILY,               "TVC_UKX_D.json",        5000),
    # ── Aktien ───────────────────────────────────────────────────────────────
    ("AAPL",   "AAPL",    "NASDAQ",     DAILY,               "NASDAQ_AAPL_D.json",    5000),
    ("AMZN",   "AMZN",    "NASDAQ",     DAILY,               "NASDAQ_AMZN_D.json",    5000),
    ("GOOGL",  "GOOGL",   "NASDAQ",     DAILY,               "NASDAQ_GOOGL_D.json",   5000),
    ("META",   "META",    "NASDAQ",     DAILY,               "NASDAQ_META_D.json",    5000),
    ("MSFT",   "MSFT",    "NASDAQ",     DAILY,               "NASDAQ_MSFT_D.json",    5000),
    ("NVDA",   "NVDA",    "NASDAQ",     DAILY,               "NASDAQ_NVDA_D.json",    5000),
    # ── Invest (OANDA) ───────────────────────────────────────────────────────
    ("NAS100USD", "NAS100USD", "OANDA", DAILY,               "OANDA_NAS100USD_D.json", 5000),
    ("USDCHF",    "USDCHF",   "OANDA",  DAILY,               "OANDA_USDCHF_D.json",   5000),
    ("EURUSD",    "EURUSD",   "OANDA",  DAILY,               "OANDA_EURUSD_D.json",   5000),
    ("GBPUSD",    "GBPUSD",   "OANDA",  DAILY,               "OANDA_GBPUSD_D.json",   5000),
    # ── FX Forex8 ────────────────────────────────────────────────────────────
    ("EURGBP",  "EURGBP", "VANTAGE",   DAILY,               "VANTAGE_EURGBP_D.json", 5000),
    ("GBPJPY",  "GBPJPY", "VANTAGE",   DAILY,               "VANTAGE_GBPJPY_D.json", 5000),
    ("MXNUSD",  "MXNUSD", "FX_IDC",   DAILY,               "FX_IDC_MXNUSD_D.json",  5000),
    ("NOK1!",   "NOK1!",  "CME",       DAILY,               "CME_NOK1_D.json",        5000),
    ("CLPUSD",  "CLPUSD", "FX_IDC",   DAILY,               "FX_IDC_CLPUSD_D.json",  5000),
    ("SEKUSD",  "SEKUSD", "FX_IDC",   DAILY,               "FX_IDC_SEKUSD_D.json",  5000),
    ("BRLUSD",  "BRLUSD", "FX_IDC",   DAILY,               "FX_IDC_BRLUSD_D.json",  5000),
    ("ZARUSD",  "ZARUSD", "FX_IDC",   DAILY,               "FX_IDC_ZARUSD_D.json",  5000),
    # ── Intraday MT ──────────────────────────────────────────────────────────
